...
import { RatingSummary } from "../../components/bv/rating-summary";
            ...
            <StyledGrid container spacing={2} item xs={12}>
              ...
              <StyledGrid item xs={12} md={6}>
                ...
                {promotion && (
                 ...
                 <div>
               <RatingSummary content={ratingSummaryContent} productId={product.id}></RatingSummary>
               </div>
                {ribbonAds.length ? (
